...
const CrushContextProvider: React.FC = props => {
  ...
  const [crushPotential, setCrushPotential] = useState<Crush[]>([
    {id: 'p0', name: 'yinyleon', photo: 'assets/avatars/avatar0.svg', desc: 'Mantap'},
    {id: 'p1', name: 'Diva Mini', photo: 'assets/avatars/avatar1.svg', desc: 'Oh yeah'},
    {id: 'p2', name: 'Sick For Lily', photo: 'assets/avatars/avatar2.svg', desc: 'Noice'},
    {id: 'p3', name: 'Reislin', photo: 'assets/avatars/avatar3.svg', desc: 'Beleh beleh'},
